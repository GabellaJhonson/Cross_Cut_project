...
public class FileDataSourceXmlTest extends TestCase {
    ...
    public void setUp() throws Exception {
        p = new MatchParser();
        pathIn = "/Users/iisuos/IdeaProjects/Kolok with test/maven_prod/src/test/java/XmlFile/inputTest.xml";
        in = new File(pathIn);
        pathOut = "/Users/iisuos/IdeaProjects/Kolok with test/maven_prod/src/test/java/XmlFile/outputTest.xml";
        out = new File(pathOut);
        String dataIn = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n" +
                "<xmlExpressionList>\n" +
                "    <expressions>\n" +
        ...
        expected = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n" +
                ...
                "    </expressions>\n" +
                "</xmlExpressionList>";
        expected_teg_expression2 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><xmlExpressionList>\n" +
                "    <expressions>\n" +
                "        <expression1>2--2</expression1>\n" +
                "        <expression2>Infinity</expression2>\n" +
                "        <expression3>Dan Jukes</expression3>\n" +
                ...
                "    </expressions>\n" +
                "</xmlExpressionList>";
        expected_AllTegs = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><xmlExpressionList>\n" +
                "    <expressions>\n" +
                "        <expression1>4.0</expression1>\n" +
                "        <expression2>Infinity</expression2>\n" +
                "        <expression3>Dan Jukes</expression3>\n" +
