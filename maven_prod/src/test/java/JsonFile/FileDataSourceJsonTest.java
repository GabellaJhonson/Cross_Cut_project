...
import TxtFile.Compression;
import TxtFile.DataSourceDecorator;
import TxtFile.Encryption;
import TxtFile.FileDataSource;
...
public class FileDataSourceJsonTest extends TestCase {
    ...
    public void setUp() throws Exception {
        p = new MatchParser();
        pathIn = "/Users/iisuos/IdeaProjects/Kolok with test/maven_prod/src/test/java/JsonFile/inputTest.json";
        in = new File(pathIn);
        pathOut = "/Users/iisuos/IdeaProjects/Kolok with test/maven_prod/src/test/java/JsonFile/outputTest.json";
